...
namespace VRC.Core
{
    public class APIUser : ApiModel
    {
        ...
        {
            get => Instance_Class.GetProperty(nameof(IsOnMobile)).GetGetMethod().Invoke<bool>(this).GetValue();
        }
        ...
        public bool IsFriendsWith(string userId) => IsFriendsWith(new IL2String_utf8(userId));
        public bool IsFriendsWith(IL2String userId)
        {
